...
import org.broadinstitute.hellbender.utils.gga.GenotypingGivenAllelesUtils;
...
public final class ReadThreadingAssembler {
     ...
     */
    @VisibleForTesting
    List<AssemblyResult> assemble(final List<SAMRecord> reads, final Haplotype refHaplotype, final List<Haplotype> givenHaplotypes) {
